            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div class="text-center" data-aos="fade-up">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="#download" class="inline-flex items-center px-8 py-4 rounded-lg text-green-600 bg-white hover:bg-gray-50 transition-all duration-300 transform hover:scale-105 shadow-lg">
                            <span class="text-lg font-semibold">Get Started Free</span>
                            <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                        </a>
                        <a href="#features" class="inline-flex items-center px-8 py-4 rounded-lg text-white border-2 border-white hover:bg-white/10 transition-all duration-300">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        <p class="text-gray-600">"This tool has saved me hours of repetitive work. Highly recommended!"</p>
                        <div class="mt-4">
                    ...
                    <!-- Testimonial 2 -->
                    <div class="bg-white p-6 rounded-lg shadow">
                        <p class="text-gray-600">"The automation features are incredible. Perfect for my business needs."</p>
                        <div class="mt-4">
                    ...
                    <!-- Testimonial 3 -->
                    <div class="bg-white p-6 rounded-lg shadow">
                        <p class="text-gray-600">"Easy to use and very reliable. Customer support is excellent!"</p>
                        <div class="mt-4">
