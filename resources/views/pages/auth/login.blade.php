...
<div
    class="min-h-screen flex flex-col justify-center items-center p-4"
>
    <div
        class="w-full sm:max-w-md px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-xl"
    >
        ...
        <form method="POST" action="{{ route('signin') }}" class="space-y-6">
            ...
            <div>
                <x-primary-button
                    class="w-full justify-center bg-gradient-to-r from-green-600 to-emerald-500 hover:opacity-90"
                >
                    {{ __("Sign in") }}
                </x-primary-button>
            </div>
