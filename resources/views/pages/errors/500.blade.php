            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <h2 class="text-2xl font-semibold text-base-dark mt-4">Server Error</h2>
                        <p class="text-base text-base-light mt-2">Something went wrong on our servers. We're working on fixing the issue.</p>
