            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <h2 class="text-2xl font-semibold text-base-dark mt-4">Forbidden</h2>
                        <p class="text-base text-base-light mt-2">You don't have permission to access this resource.</p>
