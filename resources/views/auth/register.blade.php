            ...
            <div class="bg-white py-8 px-6 shadow-lg sm:rounded-lg border border-gray-100">
                ...
                <form class="space-y-6" action="{{ route('register') }}" method="POST">
                    ...
                    <x-text-input
                        ...
                        helper="Opsional: Untuk login dan notifikasi"
                        leadingIcon='<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <x-text-input
                        ...
                        helper="Nomor telepon untuk login dan notifikasi"
                        leadingIcon='<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div x-data="{ showConfirmPassword: false }">
                        <x-text-input
                            ...
                            trailingIcon='<button type="button" @click="showConfirmPassword = !showConfirmPassword" class="text-gray-400 hover:text-gray-500 focus:outline-none">
